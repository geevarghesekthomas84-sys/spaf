...
- 🧠 Get **AI-generated threat intelligence** automatically after every scan
...
Connect to any leading AI model for Red Team-grade analysis. After **every scan**, SPAF automatically sends findings to your configured AI and generates a module-specific intelligence report covering attack paths, exploitation techniques, CVE correlation, and actionable remediation — all printed directly in the terminal.

**Auto-analysis is built into every module:**
- `recon` → Attack surface map, subdomain takeover candidates, phishing angles
- `scan` → Per-port exploitation paths, CVE PoC approaches, lateral movement
- `webscan` → Header bypass techniques, WAF evasion, developer remediation code
- `crawl` → Form injection analysis, high-value endpoint prioritization
